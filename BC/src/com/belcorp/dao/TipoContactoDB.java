...
import com.belcorp.entidades.bc.TipoDoc;
...
public class TipoContactoDB {
    private static final String metodoWeb = "getContacto"; //BBWS7ObtenerMeta?PIN=&IMEI=&IMSI=&IDAPP=&FFVV=FS&CodigoPais=21&NombreUsuario=1215&GMT=&Rol=
    private static String URL, DATA;
    private static PersistentObject persist;
    private static final long IDSTORE = 0x65fa9b3e77040ce4L; // com.belcorp.entidades.TipoContacto
    private Vector objetos;
    private Usuario usuario;

    public TipoContactoDB() {
    ...
    private boolean fillObjectos(NodeList node) throws Exception {
        ...
        for (int i = 1; i < n; i = i + 2) {
            ...
            TipoContacto item = new TipoContacto();
            item.setId(fields[0]);
    ...
    public TipoContacto getDescripcionById(String id) {
    	TipoContacto tipo = null;
        int i, n;
        n = objetos.size();
        for (i = 0; i < n; i++) {
        	tipo = (TipoContacto) objetos.elementAt(i);
