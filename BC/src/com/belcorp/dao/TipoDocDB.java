...
public class TipoDocDB {
    private static final String metodoWeb = "getTipoDocumento"; //BBWS7ObtenerMeta?PIN=&IMEI=&IMSI=&IDAPP=&FFVV=FS&CodigoPais=21&NombreUsuario=1215&GMT=&Rol=
    private static String URL, DATA;
    private static PersistentObject persist;
    private static final long IDSTORE = 0x1f80b5f9edb2003cL; // com.belcorp.entidades.TipoDoc
    ...
    public TipoDoc getDescripcionById(String id) {
        TipoDoc tipodoc = null;
        int i, n;
        n = objetos.size();
        for (i = 0; i < n; i++) {
        	tipodoc = (TipoDoc) objetos.elementAt(i);
            if(id.equals(tipodoc.getId())){
                return tipodoc;
            }
        }
        return tipodoc;
