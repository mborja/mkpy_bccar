<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteIncorporaciones.aspx.cs" Inherits="Reportes_Evaluaciones" Title="Reporte de Evaluaciones" %>
      ...
      <tr> 
         <td>
                    ...
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" 
                        Font-Names="Segoe UI" Font-Underline="False" ForeColor="#660033">Reporte de Incorporaciones</asp:HyperLink>
                        </td>
      </tr>
    </table>
    ...
    <tr>
        <td align="center">
            ...
            <table class="style1" align="center"  >
                ...
                <tr>
                    <td style="text-align: right; height: 19px;">
                        <asp:Label ID="lblModo" runat="server" Text="Modo :" CssClass="labelEs"></asp:Label>
                        </td>
                    <td style="text-align: left; height: 19px;">
                                                <asp:DropDownList ID="ddlModo" runat="server" 
                                Height="22px" onselectedindexchanged="ddlEstado_SelectedIndexChanged" Width="105px" 
                                                    CssClass="ComboEs">
                    ...
                    <td style="text-align: left; height: 19px;">
                                ...
                                Height="22px" onselectedindexchanged="ddlEstado_SelectedIndexChanged" CssClass="ComboEs">
                                                    <asp:ListItem Value="2">Todos</asp:ListItem>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    onrowcommand="GridView1_RowCommand" Width="750px" Visible="False" 
                CssClass="labelEs" PageSize="25" 
                DataKeyNames="Región,Zona,Grabación,Estado">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Grabación" HeaderText="Grabación" 
                        SortExpression="Grabación" />
            ...
            <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                ...
                SelectCommand="SP_LISTADO_REPORTE_INCORPORACIONES" 
