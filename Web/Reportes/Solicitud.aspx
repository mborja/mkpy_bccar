<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Solicitud.aspx.cs" Inherits="Reportes_Solicitud" Title="Datos de la evaluación" %>
                        ...
                        <table width="750">
                            ...
                            <tr>
                                <td style="height: 113px">
                                    <table style="width: 100%; height: 140px" align="left">
                                        <tr>
                                            <td align="left">
                                                <asp:Label ID="codConsultoraRecLabel2" runat="server" Text="Nombre :" 
                                                    CssClass="labelEs" />
                                            </td>
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="reffam_nombreLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="reffam_appatLabel" runat="server" 
                                ...
                                <td style="height: 113px">
                                    <table style="width: 100%" align="left">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="refnofam_nomLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="refnofam_appat" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="refnofam_direcLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="refnofam_telefonoLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="refnofam_celuLabel" runat="server" 
                            ...
                            <tr>
                                <td style="height: 52px;">
                                    <table style="width: 100%" align="left">
                                        <tr>
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="codConsultoraRecLabel11" runat="server" 
                                                    Text="Dirección :" />
                                            </td>
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="entrega_direcLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="entrega_puebloLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="entrega_cpostalLabel" runat="server" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="entrega_referenciaLabel" runat="server" 
                                ...
                                <td style="height: 52px">
                                    <table style="width: 100%" align="left">
                                        <tr>
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="codConsultoraRecLabel12" runat="server" 
                                                    Text="IMSI :" />
                                            </td>
                                            <td align="left">
                                                <asp:Label CssClass="labelEs" ID="record_imsiLabel" runat="server" 
        ...
        <tr>
            ...
            &nbsp;
                <asp:LinkButton ID="InsertCancelButton0" runat="server" CausesValidation="False" 
                            CommandName="Cancel" PostBackUrl="~/Reportes/Evaluaciones.aspx" 
                            Text="Exportar" CssClass="linkButtonFuncEs" />
            </td>
        </tr>
    </table>
    <br />
