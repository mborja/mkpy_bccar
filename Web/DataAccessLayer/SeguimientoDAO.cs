    ...
    public class SeguimientoDAO
    {
        ...
        public List<SeguimientoBE> obtenerPorParametros(SeguimientoBE seguimientoBE)
        {
            ...
            try
            {
                ...
                da.SelectCommand.Parameters.Add("@fechaInscripcion", SqlDbType.SmallDateTime).Value = (seguimientoBE.FechaIngreso.Length == 0) ? Convert.DBNull : Convert.ToDateTime(seguimientoBE.FechaIngreso);
