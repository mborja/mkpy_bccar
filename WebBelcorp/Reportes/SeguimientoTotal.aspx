<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SeguimientoTotal.aspx.cs" Inherits="Reportes_SeguimientoTotal" Title="Untitled Page" %>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table width="750">
                                                    ...
                                                    Text="Consultora Recomienda :" CssClass="labelEs" />
                                                        </td>
                                                        <td style="width: 191px">
            ...
            PageSize="25">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="fechaVisita" HeaderText="Fecha visita" 
                        SortExpression="fechaVisita" />
                    <asp:BoundField DataField="FechaIngreso" HeaderText="Fecha ingreso" 
                                            SortExpression="FechaIngreso" />
                    <asp:BoundField DataField="FechaBB" HeaderText="Fecha BB" 
                                            SortExpression="FechaBB" />
                    ...
                    <asp:BoundField DataField="satelites" HeaderText="Satelites" 
                        SortExpression="satelites" />
                    <asp:BoundField DataField="tipoAccion" HeaderText="Tipo acción" 
                        SortExpression="tipoAccion" />
                ...
                <AlternatingRowStyle BackColor="#d2bedc" />
                            ...
                            <asp:SqlDataSource ID="SqlSeguimientoTotal" runat="server" 
                                ...
                                SelectCommand="SELECT (SELECT codConsultora FROM Consultora WHERE (idConsultora = Segumiento.Consultora_idConsultora)) AS Consultora_idConsultora, (SELECT Codigo FROM GerenteZona WHERE (idGerenteZona = Segumiento.GerenteZona_idGerenteZona)) AS GerenteZona_idGerenteZona, FechaBB, FechaIngreso, longitud, latitude, margen, satelites, tipoAccion, fechaVisita, pin, imsi, estado FROM Segumiento WHERE (Consultora_idConsultora = (SELECT idConsultora FROM Consultora AS Consultora_1 WHERE (codConsultora = @codConsultora)))">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="codConsultora" QueryStringField="id" />
                                </SelectParameters>
                            </asp:SqlDataSource>
