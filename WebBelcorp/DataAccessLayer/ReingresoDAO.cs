    ...
    public class ReingresoDAO
    {
        ...
        public List<ReingresoBE> obtenerPorParametros(ReingresoBE reingresoBE)
        {
            ...
            try
            {
                ...
                DateTime fechaProcesadaini = new DateTime();
                DateTime fechaProcesadafin = new DateTime();
                CultureInfo culture = new CultureInfo("en-GB");

                if (reingresoBE.recFechaReingreso!=null && reingresoBE.recFechaReingreso.Length > 0)
                fechaProcesada = Convert.ToDateTime(reingresoBE.recFechaReingreso, culture);
                if (reingresoBE.recFechaReingresoIni != null && reingresoBE.recFechaReingresoIni.Length > 0)
                fechaProcesadaini = Convert.ToDateTime(reingresoBE.recFechaReingresoIni, culture);
                if (reingresoBE.recFechaReingresoFin != null && reingresoBE.recFechaReingresoFin.Length > 0)
                fechaProcesadafin = Convert.ToDateTime(reingresoBE.recFechaReingresoFin, culture);
                    
                da.SelectCommand.Parameters.Add("@fechaReingreso", SqlDbType.SmallDateTime).Value = Convert.DBNull ;
                da.SelectCommand.Parameters.Add("@fechaReingresoini", SqlDbType.SmallDateTime).Value = (reingresoBE.recFechaReingresoIni.Length == 0) ? Convert.DBNull : fechaProcesadaini;
                da.SelectCommand.Parameters.Add("@fechaReingresofin", SqlDbType.SmallDateTime).Value = (reingresoBE.recFechaReingresoFin.Length == 0) ? Convert.DBNull : fechaProcesadafin;
